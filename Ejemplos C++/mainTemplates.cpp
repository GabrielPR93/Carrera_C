...
//especializacion (para un comportamiento especifico)
...
template <unsigned int N=10> //Valor por defecto 10
...
int main() {
	...
	//foo();// Esto asi no se puede porque faltaría el tipo como a continuaciónn
    foo<int>();
    foo<float>();
    foo<double>();
    foo<char>();
